...
<div class="pointer-events-none fixed inset-0 -z-10">
    <div class="absolute left-1/2 -top-60 h-130 w-130 -translate-x-1/2 rounded-full bg-indigo-200/45 blur-3xl"></div>
    <div class="absolute -right-50 top-30 h-150 w-150 rounded-full bg-emerald-200/40 blur-3xl"></div>
</div>
...
<header class="sticky top-0 z-50 border-b border-slate-200/70 bg-white/70 backdrop-blur">
    <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <button
            id="menu-btn"
            class="inline-flex items-center cursor-pointer justify-center rounded-xl border border-slate-200 bg-white p-2 text-slate-700 active:bg-slate-100 hover:bg-slate-50 md:hidden"
    ...
    <div
        id="mobile-menu"
        data-state="closed"
        class="hidden absolute w-full border-t border-slate-200 bg-white md:hidden overflow-hidden transition-all duration-200 ease-out origin-top opacity-0 scale-95 -translate-y-1 max-h-0 pointer-events-none">
        <div class="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-3 sm:px-6">
            <a href="#jobs" class="rounded-lg px-3 py-2 text-sm text-slate-700 hover:bg-slate-50">Info Loker</a>
            <a href="#about" class="rounded-lg px-3 py-2 text-sm text-slate-700 hover:bg-slate-50">Tentang</a>
