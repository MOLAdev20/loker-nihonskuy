  ...
  @php
    ...
    $questionGroups = [
        [
            ...
            'description' => 'Berikan konteks yang jelas tentang pengalaman kerja kandidat di Jepang.',
            'items' => [
                [
                    'field' => 'workHistory',
                    'column' => 'work_history',
                    'label' => '1. Bisa ceritakan pengalaman kerja Anda sebelumnya di Jepang? (Nama perusahaan, bidang, durasi, dan tugas utama).',
                    'placeholder' => 'Tuliskan nama perusahaan, bidang kerja, durasi, dan tugas utama kandidat.',
                ],
                [
                    ...
                    'placeholder' => 'Jelaskan skill teknis yang paling dikuasai dan contoh penggunaannya.',
                ],
                [
                    ...
                    'placeholder' => 'Ceritakan situasi komunikasi yang paling menantang dan bagaimana menghadapinya.',
                ],
                [
                    'field' => 'leaveReason',
                    'column' => 'leave_reason',
                    'label' => '4. Apa alasan utama Anda memutuskan untuk mencari pekerjaan baru dan keluar dari bidang/perusahaan sebelumnya?',
                    'placeholder' => 'Jelaskan alasan utama mencari pekerjaan baru.',
                ],
            ],
        ],
        [
            'title' => 'Alasan dan Persiapan',
            'description' => 'Tunjukkan alasan kandidat memilih bidang baru dan langkah yang sudah dilakukan.',
            'items' => [
                [
                    'field' => 'applyReason',
                    'column' => 'apply_reason',
                    'label' => '5. Mengapa Anda tertarik untuk melamar di bidang yang baru ini? Apa yang membuat bidang ini menarik bagi Anda?',
                    'placeholder' => 'Tuliskan alasan kandidat tertarik pada bidang baru ini.',
                ],
                [
                    'field' => 'careerPrep',
                    'column' => 'career_prep',
                ...
                [
                    ...
                    'placeholder' => 'Tulis gambaran diri kandidat menurut rekan kerja atau atasan.',
                ],
                [
                    ...
                    'placeholder' => 'Ceritakan cara kandidat mengatasi tekanan kerja atau kendala berat.',
                ],
            ],
        ],
        [
            'title' => 'Motivasi dan Target',
            'description' => 'Jelaskan motivasi bertahan, target kerja, dan rencana jangka panjang kandidat.',
            'items' => [
                [
                ...
                [
                    ...
                    'placeholder' => 'Tuliskan rencana jangka panjang setelah kembali ke Indonesia.',
                ],
            ],
        ],
    ];
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <p class="mt-2 text-sm text-slate-500">
          Lengkapi jawaban interview untuk {{ $displayName }}.
        </p>
      </div>
  ...
  <section class="rounded-2xl border border-slate-200 bg-white shadow-sm">
    <header class="border-b border-slate-200 px-4 py-4 sm:px-6">
      ...
      <p class="mt-1 text-sm text-slate-500">
        Jawab setiap pertanyaan secara jujur dan jelas. Semua jawaban dipakai sebagai bahan
