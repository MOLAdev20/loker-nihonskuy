...
@section('content_header', 'Riwayat Pendidikan')

@section('content_subheader', 'Kelola data pendidikan Anda untuk melanjutkan proses profil.')
...
@section('content')
            ...
            <tr>
              ...
              <td class="px-4 py-4 sm:px-6">
                <div class="flex justify-end gap-2">
                  ...
                  <form method="POST"
                    action="{{ route('user.education-history.destroy', $educationHistory->id) }}"
  ...
  <x-modal name="education-history-create-modal" :show="$shouldOpenCreateModal" maxWidth="2xl" focusable>
    <div class="p-5 sm:p-6">
      ...
      <form method="POST" action="{{ route('user.education-history.store') }}">
        @csrf
  ...
  @foreach ($educationHistories as $educationHistory)
    ...
    <x-modal :name="$editModalName" :show="$isCurrentEditModal" maxWidth="2xl" focusable>
      <div class="p-5 sm:p-6">
        ...
        <form method="POST"
          action="{{ route('user.education-history.update', $educationHistory->id) }}">
          @csrf
          @method('PUT')
