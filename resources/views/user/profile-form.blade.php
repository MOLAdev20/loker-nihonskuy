            ...
            <form class="px-6 py-6" method="POST" action="{{ url('my/store-profile') }}">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="furigana" class="mt-2 w-full rounded-lg border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-800 focus:border-slate-400 focus:ring-0" placeholder="タナカ タロウ" value="{{ old('furigana') }}" />
                    </div>
                    <div>
                        <label class="text-sm font-medium text-slate-700">Nama Lengkap</label>
                        <input type="text" name="nama_lengkap" class="mt-2 w-full rounded-lg border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-800 focus:border-slate-400 focus:ring-0" placeholder="Tanaka Taro" value="{{ old('nama_lengkap') }}" />
                    </div>
                    <div>
                        <label class="text-sm font-medium text-slate-700">Tanggal Lahir</label>
                        <input type="date" name="tanggal_lahir" class="mt-2 w-full rounded-lg border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-800 focus:border-slate-400 focus:ring-0" value="{{ old('tanggal_lahir') }}" />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select name="status_pernikahan" class="mt-2 w-full rounded-lg border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-800 focus:border-slate-400 focus:ring-0">
                            <option value="Belum Menikah" @selected(old('status_pernikahan') === 'Belum Menikah')>Belum Menikah</option>
                            <option value="Menikah" @selected(old('status_pernikahan') === 'Menikah')>Menikah</option>
                            <option value="Cerai" @selected(old('status_pernikahan') === 'Cerai')>Cerai</option>
                        </select>
                    </div>
                    <div>
